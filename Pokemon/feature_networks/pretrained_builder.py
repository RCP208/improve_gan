...
def _make_pretrained(backbone, verbose=False):
    ...
    if backbone == 'vgg11_bn':
        ...
        overlay = {'file': r'/home/user/.cache/huggingface/hub/models--timm--tf_efficientnet_lite0.in1k/pytorch_model.bin'}
        model = timm.create_model(backbone, pretrained=True, pretrained_cfg_overlay=overlay)
        pretrained = _make_efficientnet(model)
