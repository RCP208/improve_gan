...
class MolGen(nn.Module):
    ...
    def train_step(self, x):
        ...
        # combined loss
        discr_loss = 0.5 * (real_loss + fake_loss) + (fake_clc + real_clc) * 0.0
        discr_loss.backward()
        ...
        x_real_pad[:batch_size, :len_real] = x_real
        mse_loss = F.mse_loss(x_gen.float(), x_real_pad.float(), reduction='mean') * 0.0001
        ...
        generator_loss = generator_loss_
