...
from metric import frechet_inception_distance
from metric import kernel_inception_distance
from metric import precision_recall
from metric import perceptual_path_length
from metric import inception_score
from metric import equivariance
#----------------------------------------------------------------------------
...
# a = list_valid_metrics()
# print(a)
# print(is_valid_metric('is50k'))